...
function saveResponse(response) {
    ...
    fetch(SB_ajax_object.ajax_url, {
        ...
        body: 'action=hgf_korrektur_save_response&response=' + encodeURIComponent(response) + '&nonce=' + HGF_ajax_object.nonce
    })
...
function getSavedResponses() {
    ...
    return fetch(SB_ajax_object.ajax_url + '?action=hgf_korrektur_get_user_responses&nonce=' + HGF_ajax_object.nonce)
        .then(response => response.json())
        .then(data => {
            if (data.success) {
...
function deleteResponse(responseId) {
    ...
    fetch(SB_ajax_object.ajax_url, {
        ...
        body: 'action=hgf_korrektur_delete_response&response_id=' + responseId + '&nonce=' + HGF_ajax_object.nonce
    })
        .then(response => response.json())
        .then(data => {
            if (data.success) {
