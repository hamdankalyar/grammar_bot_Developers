...
// Add this import at the top of history.js
...
function deleteResponse(responseId) {
  // NEW:
  historyLoader.showHistoryLoader("savedResponsesList", "loader1");
  ...
  getSavedResponses()
    .then((savedResponses) => {
      ...
      if (savedResponses.length === 0) {
        ...
        // NEW:
        historyLoader.hideHistoryLoader("savedResponsesList");
        return;
      } else {
    ...
    .catch((error) => {
      ...
      // NEW:
      historyLoader.hideHistoryLoader("savedResponsesList"); // Make sure we hide the loader even if there's an error
    });
}
