...
function sendRewriteRequest(buttonId) {
    ...
    const { originalContent, showLoader, hideLoader, displayResponse, onResponseGenerated, languageMap, getCurrentLanguage, HGF_ajax_object } = window._rewriteSystem;
    ...
    let langForRewrite = Object.keys(languageMap).find(key => languageMap[key] === getCurrentLanguage()) || getCurrentLanguage();
