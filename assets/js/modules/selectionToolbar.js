...
const getDependencies = () => ({
    ...
    quillHtmlToPlainTextWithParagraphs: window.quillHtmlToPlainTextWithParagraphs || (() => (html) => html),
...
class QuillSelectionToolbar {
    ...
    async copyText() {
        ...
        try {
            ...
            if (deps.quillHtmlToPlainTextWithParagraphs && typeof deps.quillHtmlToPlainTextWithParagraphs === 'function') {
                textContent = deps.quillHtmlToPlainTextWithParagraphs(htmlContent);
            }

            if (deps.isMobileDevice && typeof deps.isMobileDevice === 'function' && deps.isMobileDevice()) {
