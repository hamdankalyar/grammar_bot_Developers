...
function checkUserMembership() {
    return fetch(HGF_ajax_object.ajax_url + '?action=login_check_user_membership&nonce=' + HGF_ajax_object.nonce)
    ...
    fetch(HGF_ajax_object.ajax_url, {
        ...
        .then(data => {
            if (data.success) {
                ...
                const responseCount = getCurrentRewriteResponses()[getCurrentParagraphIndex()].responses.length;
